...
typora-root-url: ../../
layout: post
title: Windows - Programacion de tareas
categories: wserver
conToc: true
permalink: wserver-administracion-programador-tareas
---

En cualquier sistema es necesario programar ciertas tareas periódicas para que se realicen automáticamente. En un servidor, esta característica adquiere una mayor importancia.

Para acceder al **Programador de tareas** iremos a Administración del Servidor->Herramientas->Programador de tareas.

> -info- También podemos acceder al Programador ejecutando la orden **taskschd.msc**

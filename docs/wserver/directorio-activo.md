...
![image-20240411133253794](../assets/img/windows_server/image-20240411133253794.png)
...
- **Árboles de dominios (Tree)**: Los árboles están compuestos por uno o varios dominios. Estos dominios están dentro del mismo espacio de nombres.
  ...
  ![image-20230910113519819](../assets/img/windows_server/image-20230910113519819.png)
...
- **Bosque (Forest)**: Colección de árboles. Los dominios dentro de un bosque establecen relaciones de confianza, y esto les permite compartir recursos. Los dominios dentro del bosque no comparten el mismo espacio de nombres.
  ...
  ![image-20230910115708152](../assets/img/windows_server/image-20230910115708152.png)
...
- **Catálogo Global (Global Catalog):**   Es un servidor que almacena una copia completa de todos los objetos del directorio para su dominio host y una copia parcial de solo lectura de todos los objetos del resto de dominios del bosque. 
  ...
  ![image-20230910115844695](../assets/img/windows_server/image-20230910115844695.png)
...
- Realizamos una instalación limpia de Windows Server 2019 con interfaz gráfica (GUI) en VirtualBox. 
  ...
  ![image-20230910121125218](../assets/img/windows_server/image-20230910121125218.png)

- El adaptador de red en VirtualBox lo cambiamos a **Red Interna.**

![image-20230910121215311](../assets/img/windows_server/image-20230910121215311.png)

- Instalamos VirtualBox Guest Additions 

![image-20230910121259019](../assets/img/windows_server/image-20230910121259019.png)

- Renombramos el nombre del equipo a **empresa-DC1**

![image-20231007202930334](../assets/img/windows_server/image-20231007202930334.png)

- Abrimos el **Administrador del Servidor**

  - Seleccionamos **Servidor Local**

    ![image-20230910121710000](../assets/img/windows_server/image-20230910121710000.png)

- Un controlador de dominio (DC) no puede tener una IP dinámica, así que la cambiamos por la siguiente estática:

![image-20230910121803201](../assets/img/windows_server/image-20230910121803201.png)
...
![image-20230910121844060](../assets/img/windows_server/image-20230910121844060.png)
...
![image-20230910122001429](../assets/img/windows_server/image-20230910122001429.png)
...
![image-20230910135549160](../assets/img/windows_server/image-20230910135549160.png)



![image-20230910135626044](../assets/img/windows_server/image-20230910135626044.png)

![image-20230910135654515](../assets/img/windows_server/image-20230910135654515.png)



![image-20230910135709834](../assets/img/windows_server/image-20230910135709834.png)
...
![image-20230910135739606](../assets/img/windows_server/image-20230910135739606.png)
...
![image-20230910135904288](../assets/img/windows_server/image-20230910135904288.png)
...
![image-20230910140658068](../assets/img/windows_server/image-20230910140658068.png)
...
![image-20230910140734020](../assets/img/windows_server/image-20230910140734020.png)
...
![image-20230910140821280](../assets/img/windows_server/image-20230910140821280.png)
...
![image-20231007195424356](../assets/img/windows_server/image-20231007195424356.png)



A continuación elegimos la opción "**Seleccionar un servidor del grupo de servidores**".

![image-20231007203317189](../assets/img/windows_server/image-20231007203317189.png)
...
![image-20231007195714453](../assets/img/windows_server/image-20231007195714453.png)
...
![image-20231007195908139](../assets/img/windows_server/image-20231007195908139.png)
...
![image-20231007203356399](../assets/img/windows_server/image-20231007203356399.png)
...
![image-20231007203507554](../assets/img/windows_server/image-20231007203507554.png)



Para continuar, debemos marcar la opción *Continuar con la eliminación*.

![image-20231007203609424](../assets/img/windows_server/image-20231007203609424.png)



Escribimos la contraseña para la cuenta de Administrador.

![image-20231007203713083](../assets/img/windows_server/image-20231007203713083.png)



Hacemos clic en **Disminuir nivel**

![image-20231007203809019](../assets/img/windows_server/image-20231007203809019.png)



Después, el sistema comenzará a reiniciarse.

![image-20231007204612720](../assets/img/windows_server/image-20231007204612720.png)
...
![image-20231007204912200](../assets/img/windows_server/image-20231007204912200.png)



Seleccionar un servidor del grupo de servidores

![image-20231007204947091](../assets/img/windows_server/image-20231007204947091.png)
...
- Creación de un nuevo Usuario
  ...
  ![image-20230917113354040](../assets/img/windows_server/image-20230917113354040.png)

  ![image-20230917113410413](../assets/img/windows_server/image-20230917113410413.png)

  **Pestaña: Cuenta**

  **Establecer horas de inicio de sesión**

  ![image-20230917113501840](../assets/img/windows_server/image-20230917113501840.png)

**Pestaña: Cuenta**

**Limitar los equipos desde los que un usuario puede acceder**

![image-20230917113539602](../assets/img/windows_server/image-20230917113539602.png)
...
![image-20231003113646220](../assets/img/windows_server/image-20231003113646220.png)
...
![image-20231003120446770](../assets/img/windows_server/image-20231003120446770.png)
...
![image-20231003175922893](../assets/img/windows_server/image-20231003175922893.png)
